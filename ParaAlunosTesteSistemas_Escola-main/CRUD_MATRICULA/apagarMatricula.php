...
<body class="bg-light">
    ...
    <div class="container py-5">
        ...
        <header class="text-center mb-4">
            ...
            <h2 class="h4 text-danger mt-3">Apagar Dados de Matrícula</h2>
        </header>
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-sm border-0 border-danger border-top border-4">
                    <div class="card-body p-4 p-md-5">
                        
                        <h3 class="h4 text-center mb-4 fw-bold text-danger">Procurar Matrícula para Excluir</h3>

                        <form method="POST" action="formApagarMatricula.php">
                            <div class="mb-4">
                                <label for="idBusca" class="form-label fw-bold">ID da Matrícula:</label>
                                <input type="text" class="form-control form-control-lg" name="ID" id="idBusca" maxlength="6" placeholder="Digite o ID que deseja apagar..." required>
                            </div>
                            
                            <div class="d-flex justify-content-center gap-3">
                                <button type="reset" class="btn btn-outline-secondary px-4">Limpar Dados</button>
                                <button type="submit" class="btn btn-danger px-5 fw-bold shadow-sm">Procurar</button>
                            </div>
                        </form>
