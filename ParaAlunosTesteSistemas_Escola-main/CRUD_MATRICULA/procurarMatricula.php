...
<body class="bg-light">
    ...
    <div class="container py-5">
        ...
        <header class="text-center mb-4">
            ...
            <h2 class="h4 text-danger mt-3">Formulário de Procura de Matrícula</h2>
        </header>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <h3 class="h4 text-center mb-4 fw-semibold text-secondary">Procurar Matrícula</h3>

                        <form method="POST" action="consultaMatricula.php">
                            <div class="mb-4">
                                <label for="idBusca" class="form-label fw-bold">ID da Matrícula:</label>
                                <input type="text" class="form-control form-control-lg" name="id" id="idBusca" placeholder="Digite o ID da matrícula..." required>
                            </div>
                            
                            <div class="d-flex justify-content-center gap-3">
                                <button type="reset" class="btn btn-outline-secondary px-4">Limpar Dados</button>
                                <button type="submit" class="btn btn-primary px-5 fw-bold shadow-sm">Procurar</button>
                            </div>
                        </form>
