...
<body class="bg-light">
    ...
    <div class="container py-5">
        ...
        <header class="text-center mb-4">
            ...
            <h2 class="h4 text-danger mt-3">Alteração de Dados do Aluno</h2>
        </header>
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="POST" action="formAtualizar.php">
                            <div class="mb-4 text-center">
                                ...
                                <input type="text" id="idBusca" class="form-control form-control-lg text-center" name="ID" placeholder="Digite o ID para alterar...">
                            </div>
        ...
        <div class="d-flex flex-wrap justify-content-center gap-2 mb-4">
            ...
            <form method="POST" action="apagar.php">
                <button type="submit" class="btn btn-danger">Apagar Dados do Aluno</button>
            </form>
        </div>
